        ...
        <div className="mb-6 p-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
          ...
          <div className="border-t border-blue-200 dark:border-blue-700 pt-3">
            ...
            <div className="text-xs text-gray-700 dark:text-gray-300 space-y-2">
              ...
              <div>
                <p className="font-medium">Quiz Generation Examples:</p>
                <ul className="ml-4 space-y-0.5">
                  <li>• <strong>Per minute:</strong> ~5-10 quiz sets (each with 5-10 questions)</li>
                  <li>• <strong>Per request:</strong> 3-5 topic quizzes with 10-50 total questions</li>
                  <li>• <strong>With uploaded files:</strong> Process study materials up to 10MB</li>
                  <li>• <strong>Bulk generation:</strong> Multiple topics in one go</li>
                  <li>• <strong>Daily capacity:</strong> Hundreds of quizzes for personal study</li>
                </ul>
              </div>

              <div className="mt-3 p-2 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded">
                <p className="text-green-800 dark:text-green-200">
                  <strong>💡 Pro Tip:</strong> Generate multiple quizzes in one request by describing all topics 
